...
The best way to use this system is to experiment and analyse the output using the two marimo notebooks.
...
Once you have opened this, scrolling down to workspace, you will find the two notebooks under models/it2r2 (ignore notebooks under 'shed' as they pertain to earlier models).
